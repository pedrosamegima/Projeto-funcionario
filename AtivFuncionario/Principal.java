package AtivFuncionario;

public class Principal {

	public static void main(String[] args) {
		Jornada jornada = new Jornada(1,"Pedro","15997214905",2525, "Rua antonio cardoso");
		System.out.println("\nJornada: ");
		...
		Horista horista = new Horista(1,"Pedro","15997214905",24225, "Av virgilio de rezende");
		System.out.println("\nHorista: ");
		...
		PessoaJuridica pessoaJuridica = new PessoaJuridica(1,"Pedro","15997214905",24225, "Av virgilio de rezende");
		System.out.println("\nPessoaJuridica: ");
